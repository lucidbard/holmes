...
var module = (function () {
    ...
    var can: HTMLCanvasElement, ctx: CanvasRenderingContext2D, canX, canY, mouseIsDown = 0;
    ...
    */
    ...
    function myPlayToggle(playTrue) {
        if (video.paused) {
            ...
            video.play();
            //console.log(e_cur_segment);
            //console.log(e_curTime);
        } else if (!playTrue) {
            video.pause();
            window.clearTimeout(e_nextSegmentTrigger);
        }
...
/*        thumb_ctx.font = "32pt Helvetica";
        ...
        $(img).mouseover(function (e) {
            var curTarget = (<HTMLElement>e.currentTarget);
    ...
    function renderShots() {
      ...
      thumb_can = <HTMLCanvasElement>document.createElement("canvas");
...
/*        // Load beats (experimental)
        ...
        var newCanvas: HTMLCanvasElement = <HTMLCanvasElement>$("#timeline").get(0);
        newCanvas.width = $('body').innerWidth();
        newCanvas.height = 50;
        $("#shot_sequence").width( $('body').innerWidth().toString() + "px");
        var editCanvas = <HTMLCanvasElement>$("#editTimeline").get(0);
        editCanvas.width = $('body').outerWidth();
        editCanvas.height = 50;
        can = <HTMLCanvasElement>document.getElementById("timeline");
        ctx = <CanvasRenderingContext2D>can.getContext("2d");
